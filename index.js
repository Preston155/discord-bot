...
const SESSION_BANNER_URL =
  "https://media.discordapp.net/attachments/1452829338545160285/1466919030127591613/ILLEGAL_FIREARM_1.png?ex=6983c44e&is=698272ce&hm=9f87e357408634ca251753ff48dd05dd8639b0e0eea3b71d4ec6ea55d35b9a0a&=&format=webp&quality=lossless";
...
client.on("interactionCreate", async (interaction) => {
  ...
  if (tickets[interaction.channelId]) {
    ...
    if (interaction.customId === "ticket_claim") ticket.claimed = interaction.user.id;
    if (interaction.customId === "ticket_unclaim") ticket.claimed = null;
  ...
  /* ---- POLL BUTTONS ---- */
  if (polls[interaction.message.id]) {
  ...
  return interaction.editReply("❌ Unknown interaction.");
});
